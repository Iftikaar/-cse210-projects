...
class Program
{
    static void Main(string[] args)
    {
        ...
        library.AddScripture(new Reference("Deuteronomy", 31,6), "Be strong and courageous. Do not fear or be in dread of them, for it is the Lord your God who goes with you. He will not leave you or forsake you.");
